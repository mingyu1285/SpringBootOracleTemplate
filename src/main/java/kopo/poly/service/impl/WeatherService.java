...
public class WeatherService implements IWeatherService {
    ...
    public WeatherDTO getWeather(WeatherDTO pDTO) throws Exception {
        ...
        String apiParam = "?lat=" + lat + "&long=" + lon + "&appid=" + apiKey + "&units=metric";
        ...
        for (Map<String, Object> dailyMap : dailyList) {
            ...
            // 숫자형태보다 문자열 형태가 데이터 처리하기 쉽기 때문에 Double 형태를 문자열로 변경함
            String dayTemp = String.valueOf(dailyTemp.get("day")); // 평균기온
            String dayTempMax = String.valueOf(dailyTemp.get("max")); // 최고기온
            ...
            pList.add(wdDTO); // 일별 날씨 정보를 List에 추가
